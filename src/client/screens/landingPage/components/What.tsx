...
const What = (props: any) => {
  ...
  return (
    <div className="w-full bg-transparent flex flex-row justify-center items-center mt-20">
      <div className="w-full bg-transparent flex flex-row justify-center items-center mt-20" style={{ maxWidth: 1160 }}>
        <div className="flex w-full lg:w-fit lg:flex-1 items-center">
          {WhatIsPantheumGraph}
        </div>
        <div className="flex w-full lg:w-fit lg:flex-1 flex-col mt-4" style={{ paddingLeft: 100 }}>
          ...
          <div className="flex flex-col justify-center items-center text-left" style={{
            color: "#8593C5",
            fontFamily: "Mulish",
            fontSize: "18px",
            fontStyle: "normal",
